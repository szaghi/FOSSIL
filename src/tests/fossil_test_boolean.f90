...
!<      + selection + stitching, end to end. The 3D offset (rather than a
!<      single-axis offset) was chosen to avoid the coplanar / shared-edge
!<      configurations that trip the current Möller tri-tri implementation
!<      — see the §1.1 limitation note in fossil_facet_object%intersect_facet.
