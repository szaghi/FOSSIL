...
are_tests_passed(2) = file_1%facet(5)%vertex(2)%x == 0.683601_R8P
are_tests_passed(3) = file_1%facet(5)%vertex(2)%y == -0.00763869_R8P
are_tests_passed(4) = file_1%facet(5)%vertex(2)%z == 0._R8P
...
are_tests_passed(6) = file_2%facet(5)%vertex(2)%x == 0.683601_R8P
are_tests_passed(7) = file_2%facet(5)%vertex(2)%y == -0.00763869_R8P
are_tests_passed(8) = file_2%facet(5)%vertex(2)%z == 0._R8P
