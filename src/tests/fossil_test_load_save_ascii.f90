...
are_tests_passed(2) = file_1%facet(5)%vertex_2(1) == 0.683601_R4P
are_tests_passed(3) = file_1%facet(5)%vertex_2(2) == -0.00763869_R4P
are_tests_passed(4) = file_1%facet(5)%vertex_2(3) == 0._R4P
...
are_tests_passed(6) = file_2%facet(5)%vertex_2(1) == 0.683601_R4P
are_tests_passed(7) = file_2%facet(5)%vertex_2(2) == -0.00763869_R4P
are_tests_passed(8) = file_2%facet(5)%vertex_2(3) == 0._R4P
