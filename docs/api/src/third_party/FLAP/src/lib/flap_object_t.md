...
**Source**: `src/third_party/FLAP/src/lib/flap_object_t.F90`
...
|------|------|--------|------------|-------------|
| `self` | class([object](/api/src/third_party/FLAP/src/lib/flap_object_t#object)) | inout |  | Object data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([object](/api/src/third_party/FLAP/src/lib/flap_object_t#object)) | in |  | Object data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([object](/api/src/third_party/FLAP/src/lib/flap_object_t#object)) | inout |  | Left hand side. |
| `rhs` | class([object](/api/src/third_party/FLAP/src/lib/flap_object_t#object)) | in |  | Rigth hand side. |
