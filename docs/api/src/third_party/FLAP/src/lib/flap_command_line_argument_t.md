...
**Source**: `src/third_party/FLAP/src/lib/flap_command_line_argument_t.F90`
...
|------|------|--------|------------|-------------|
| `self` | class([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | inout |  | CLA data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | inout |  | CLAsG data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | inout |  | Left hand side. |
| `rhs` | type([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | in |  | Rigth hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | type([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | inout |  | CLA data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | in |  | CLAs group data. |
| `pref` | character(len=*) | in | optional | Prefixing string. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([command_line_argument](/api/src/third_party/FLAP/src/lib/flap_command_line_argument_t#command-line-argument)) | in |  | CLA data. |
