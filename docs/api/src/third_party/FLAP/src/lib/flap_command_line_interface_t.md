...
**Source**: `src/third_party/FLAP/src/lib/flap_command_line_interface_t.F90`
...
| `clasg` | type([command_line_arguments_group](/api/src/third_party/FLAP/src/lib/flap_command_line_arguments_group_t#command-line-arguments-group)) | allocatable | CLA list [1:Na]. |
...
|------|------|--------|------------|-------------|
| `self` | class([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | inout |  | CLI data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | in |  | CLI data. |
| `pref` | character(len=*) | in | optional | Prefixing string. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | inout |  | Object data. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | inout |  | Left hand side. |
| `rhs` | type([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | type([command_line_interface](/api/src/third_party/FLAP/src/lib/flap_command_line_interface_t#command-line-interface)) | inout |  | CLI data. |
