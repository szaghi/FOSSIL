...
**Source**: `src/third_party/VTKFortran/src/lib/vtk_fortran_vtk_file_xml_writer_binary_local.f90`

**Dependencies**

```mermaid
graph LR
  vtk_fortran_vtk_file_xml_writer_binary_local["vtk_fortran_vtk_file_xml_writer_binary_local"] --> penf["penf"]
  vtk_fortran_vtk_file_xml_writer_binary_local["vtk_fortran_vtk_file_xml_writer_binary_local"] --> stringifor["stringifor"]
...
|------|------|--------|------------|-------------|
| `self` | class([xml_writer_binary_local](/api/src/third_party/VTKFortran/src/lib/vtk_fortran_vtk_file_xml_writer_binary_local#xml-writer-binary-local)) | inout |  | Writer. |
