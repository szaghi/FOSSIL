...
```mermaid
graph LR
  vtk_fortran_vtk_file_xml_writer_abstract["vtk_fortran_vtk_file_xml_writer_abstract"] --> foxy["foxy"]
  vtk_fortran_vtk_file_xml_writer_abstract["vtk_fortran_vtk_file_xml_writer_abstract"] --> penf["penf"]
  vtk_fortran_vtk_file_xml_writer_abstract["vtk_fortran_vtk_file_xml_writer_abstract"] --> stringifor["stringifor"]
...
flowchart TD
  ...
  write_topology_tag["write_topology_tag"] --> str["str"]
  write_topology_tag["write_topology_tag"] --> write_end_tag["write_end_tag"]
  write_topology_tag["write_topology_tag"] --> write_self_closing_tag["write_self_closing_tag"]
  write_topology_tag["write_topology_tag"] --> write_start_tag["write_start_tag"]
...
flowchart TD
  ...
  write_dataarray_tag["write_dataarray_tag"] --> str["str"]
  write_dataarray_tag["write_dataarray_tag"] --> write_tag["write_tag"]
...
flowchart TD
  ...
  write_dataarray_tag_appended["write_dataarray_tag_appended"] --> str["str"]
  write_dataarray_tag_appended["write_dataarray_tag_appended"] --> write_self_closing_tag["write_self_closing_tag"]
...
flowchart TD
  ...
  write_piece_start_tag["write_piece_start_tag"] --> str["str"]
  write_piece_start_tag["write_piece_start_tag"] --> write_start_tag["write_start_tag"]
...
flowchart TD
  ...
  write_piece_start_tag_unst["write_piece_start_tag_unst"] --> str["str"]
  write_piece_start_tag_unst["write_piece_start_tag_unst"] --> write_start_tag["write_start_tag"]
