...
```mermaid
graph LR
  vecfor_RPP["vecfor_RPP"] --> iso_fortran_env["iso_fortran_env"]
  vecfor_RPP["vecfor_RPP"] --> penf["penf"]
```
...
- [distance_to_plane](#distance-to-plane)
- [distance_vectorial_to_plane](#distance-vectorial-to-plane)
- [face_normal3](#face-normal3)
- [face_normal4](#face-normal4)
- [iolen](#iolen)
- [is_collinear](#is-collinear)
- [is_concyclic](#is-concyclic)
- [normalized](#normalized)
- [normL2](#norml2)
- [projection_onto_plane](#projection-onto-plane)
- [sq_norm](#sq-norm)
...
|------|------|------------|-------------|
| `ex` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | parameter | X direction versor. |
| `ey` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | parameter | Y direction versor. |
| `ez` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | parameter | Z direction versor. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | inout |  | Vector. |
...
flowchart TD
  ...
  normalize["normalize"] --> normL2["normL2"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Vector. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Vector data. |
| `unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Logic unit. |
| `fmt` | character(len=*) | in | optional | IO format. |
| `pos` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Position specifier. |
| `iostat` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | IO error. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | inout |  | Vector. |
| `normal` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Normal of mirroring plane. |
...
flowchart TD
  ...
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix["mirror_matrix"]
...
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | inout |  | Vector. |
| `axis` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Axis of rotation. |
...
flowchart TD
  ...
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix["rotation_matrix"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | inout |  | Left hand side. |
| `rhs` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `axis` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Axis of ratation. |
...
flowchart TD
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix["rotation_matrix"]
  rotation_matrix["rotation_matrix"] --> normalized["normalized"]
  style rotation_matrix fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix["mirror_matrix"]
  mirror_matrix["mirror_matrix"] --> normalized["normalized"]
  style mirror_matrix fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
**Returns**: type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector))
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Left hand side. |
| `rhs` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Right hand side. |
...
| `rhs` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Compute the component of `lhs` parallel to `rhs`. |
| `rhs` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Right hand side. |
...
```mermaid
flowchart TD
  parallel["parallel"] --> normL2["normL2"]
  parallel["parallel"] --> normalized["normalized"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | The first vector. |
| `other` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Other vector. |
...
flowchart TD
  ...
  angle["angle"] --> normL2["normL2"]
  angle["angle"] --> normalized["normalized"]
  style angle fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | First line point. |
| `pt2` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Second line point. |

**Call graph**

```mermaid
flowchart TD
  is_collinear["is_collinear"] --> distance_to_line["distance_to_line"]
  ...
  distance_to_line["distance_to_line"] --> normL2["normL2"]
  style distance_to_line fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | First plane point. |
| `pt2` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Second plane point. |
| `pt3` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Third plane point. |
...
flowchart TD
  ...
  distance_to_plane["distance_to_plane"] --> face_normal3["face_normal3"]
  style distance_to_plane fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  projection_onto_plane["projection_onto_plane"] --> distance_vectorial_to_plane["distance_vectorial_to_plane"]
  ...
  distance_vectorial_to_plane["distance_vectorial_to_plane"] --> face_normal3["face_normal3"]
  style distance_vectorial_to_plane fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `pt1` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | First face point. |
| `pt2` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Second face point. |
| `pt3` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Third face point. |
...
flowchart TD
  distance_to_plane["distance_to_plane"] --> face_normal3["face_normal3"]
  distance_vectorial_to_plane["distance_vectorial_to_plane"] --> face_normal3["face_normal3"]
  face_normal3["face_normal3"] --> normalized["normalized"]
  style face_normal3 fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
| `pt2` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Second face point. |
| `pt3` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Third face point. |
| `pt4` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Fourth face point. |
| `norm` | character(len=1) | in | optional | If 'norm' is passed as argument the normal is normalized. |
...
```mermaid
flowchart TD
  face_normal4["face_normal4"] --> normalized["normalized"]
  style face_normal4 fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  is_collinear["is_collinear"] --> distance_to_line["distance_to_line"]
  style is_collinear fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Vector. |
| `pt1` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | First arc point. |
| `pt2` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Second arc point. |
| `pt3` | type([vector](/api/src/third_party/VecFor/src/lib/vecfor_RPP#vector)) | in |  | Third arc point. |
...
flowchart TD
  ...
  style is_concyclic fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  ...
  parallel["parallel"] --> normalized["normalized"]
  rotation_matrix["rotation_matrix"] --> normalized["normalized"]
  vector_eq_vector["vector_eq_vector"] --> normalized["normalized"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normalized["normalized"]
  normalized["normalized"] --> normalize["normalize"]
  style normalized fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```mermaid
flowchart TD
  I1P_eq_vector["I1P_eq_vector"] --> normL2["normL2"]
  I1P_great_eq_vector["I1P_great_eq_vector"] --> normL2["normL2"]
  I1P_great_vector["I1P_great_vector"] --> normL2["normL2"]
  I1P_low_eq_vector["I1P_low_eq_vector"] --> normL2["normL2"]
  I1P_low_vector["I1P_low_vector"] --> normL2["normL2"]
  I1P_not_eq_vector["I1P_not_eq_vector"] --> normL2["normL2"]
  I2P_eq_vector["I2P_eq_vector"] --> normL2["normL2"]
  I2P_great_eq_vector["I2P_great_eq_vector"] --> normL2["normL2"]
  I2P_great_vector["I2P_great_vector"] --> normL2["normL2"]
  I2P_low_eq_vector["I2P_low_eq_vector"] --> normL2["normL2"]
  I2P_low_vector["I2P_low_vector"] --> normL2["normL2"]
  I2P_not_eq_vector["I2P_not_eq_vector"] --> normL2["normL2"]
  I4P_eq_vector["I4P_eq_vector"] --> normL2["normL2"]
  I4P_great_eq_vector["I4P_great_eq_vector"] --> normL2["normL2"]
  I4P_great_vector["I4P_great_vector"] --> normL2["normL2"]
  I4P_low_eq_vector["I4P_low_eq_vector"] --> normL2["normL2"]
  I4P_low_vector["I4P_low_vector"] --> normL2["normL2"]
  I4P_not_eq_vector["I4P_not_eq_vector"] --> normL2["normL2"]
  I8P_eq_vector["I8P_eq_vector"] --> normL2["normL2"]
  I8P_great_eq_vector["I8P_great_eq_vector"] --> normL2["normL2"]
  I8P_great_vector["I8P_great_vector"] --> normL2["normL2"]
  I8P_low_eq_vector["I8P_low_eq_vector"] --> normL2["normL2"]
  I8P_low_vector["I8P_low_vector"] --> normL2["normL2"]
  I8P_not_eq_vector["I8P_not_eq_vector"] --> normL2["normL2"]
  R16P_eq_vector["R16P_eq_vector"] --> normL2["normL2"]
  R16P_great_eq_vector["R16P_great_eq_vector"] --> normL2["normL2"]
  R16P_great_vector["R16P_great_vector"] --> normL2["normL2"]
  R16P_low_eq_vector["R16P_low_eq_vector"] --> normL2["normL2"]
  R16P_low_vector["R16P_low_vector"] --> normL2["normL2"]
  R16P_not_eq_vector["R16P_not_eq_vector"] --> normL2["normL2"]
  R4P_eq_vector["R4P_eq_vector"] --> normL2["normL2"]
  R4P_great_eq_vector["R4P_great_eq_vector"] --> normL2["normL2"]
  R4P_great_vector["R4P_great_vector"] --> normL2["normL2"]
  R4P_low_eq_vector["R4P_low_eq_vector"] --> normL2["normL2"]
  R4P_low_vector["R4P_low_vector"] --> normL2["normL2"]
  R4P_not_eq_vector["R4P_not_eq_vector"] --> normL2["normL2"]
  R8P_eq_vector["R8P_eq_vector"] --> normL2["normL2"]
  R8P_great_eq_vector["R8P_great_eq_vector"] --> normL2["normL2"]
  R8P_great_vector["R8P_great_vector"] --> normL2["normL2"]
  R8P_low_eq_vector["R8P_low_eq_vector"] --> normL2["normL2"]
  R8P_low_vector["R8P_low_vector"] --> normL2["normL2"]
  R8P_not_eq_vector["R8P_not_eq_vector"] --> normL2["normL2"]
  angle["angle"] --> normL2["normL2"]
  distance_to_line["distance_to_line"] --> normL2["normL2"]
  normalize["normalize"] --> normL2["normL2"]
  parallel["parallel"] --> normL2["normL2"]
  solid_angle["solid_angle"] --> normL2["normL2"]
  vector_eq_I1P["vector_eq_I1P"] --> normL2["normL2"]
  vector_eq_I2P["vector_eq_I2P"] --> normL2["normL2"]
  vector_eq_I4P["vector_eq_I4P"] --> normL2["normL2"]
  vector_eq_I8P["vector_eq_I8P"] --> normL2["normL2"]
  vector_eq_R16P["vector_eq_R16P"] --> normL2["normL2"]
  vector_eq_R4P["vector_eq_R4P"] --> normL2["normL2"]
  vector_eq_R8P["vector_eq_R8P"] --> normL2["normL2"]
  vector_eq_vector["vector_eq_vector"] --> normL2["normL2"]
  vector_great_I1P["vector_great_I1P"] --> normL2["normL2"]
  vector_great_I2P["vector_great_I2P"] --> normL2["normL2"]
  vector_great_I4P["vector_great_I4P"] --> normL2["normL2"]
  vector_great_I8P["vector_great_I8P"] --> normL2["normL2"]
  vector_great_R16P["vector_great_R16P"] --> normL2["normL2"]
  vector_great_R4P["vector_great_R4P"] --> normL2["normL2"]
  vector_great_R8P["vector_great_R8P"] --> normL2["normL2"]
  vector_great_eq_I1P["vector_great_eq_I1P"] --> normL2["normL2"]
  vector_great_eq_I2P["vector_great_eq_I2P"] --> normL2["normL2"]
  vector_great_eq_I4P["vector_great_eq_I4P"] --> normL2["normL2"]
  vector_great_eq_I8P["vector_great_eq_I8P"] --> normL2["normL2"]
  vector_great_eq_R16P["vector_great_eq_R16P"] --> normL2["normL2"]
  vector_great_eq_R4P["vector_great_eq_R4P"] --> normL2["normL2"]
  vector_great_eq_R8P["vector_great_eq_R8P"] --> normL2["normL2"]
  vector_great_eq_vector["vector_great_eq_vector"] --> normL2["normL2"]
  vector_great_vector["vector_great_vector"] --> normL2["normL2"]
  vector_low_I1P["vector_low_I1P"] --> normL2["normL2"]
  vector_low_I2P["vector_low_I2P"] --> normL2["normL2"]
  vector_low_I4P["vector_low_I4P"] --> normL2["normL2"]
  vector_low_I8P["vector_low_I8P"] --> normL2["normL2"]
  vector_low_R16P["vector_low_R16P"] --> normL2["normL2"]
  vector_low_R4P["vector_low_R4P"] --> normL2["normL2"]
  vector_low_R8P["vector_low_R8P"] --> normL2["normL2"]
  vector_low_eq_I1P["vector_low_eq_I1P"] --> normL2["normL2"]
  vector_low_eq_I2P["vector_low_eq_I2P"] --> normL2["normL2"]
  vector_low_eq_I4P["vector_low_eq_I4P"] --> normL2["normL2"]
  vector_low_eq_I8P["vector_low_eq_I8P"] --> normL2["normL2"]
  vector_low_eq_R16P["vector_low_eq_R16P"] --> normL2["normL2"]
  vector_low_eq_R4P["vector_low_eq_R4P"] --> normL2["normL2"]
  vector_low_eq_R8P["vector_low_eq_R8P"] --> normL2["normL2"]
  vector_low_eq_vector["vector_low_eq_vector"] --> normL2["normL2"]
  vector_low_vector["vector_low_vector"] --> normL2["normL2"]
  vector_not_eq_I1P["vector_not_eq_I1P"] --> normL2["normL2"]
  vector_not_eq_I2P["vector_not_eq_I2P"] --> normL2["normL2"]
  vector_not_eq_I4P["vector_not_eq_I4P"] --> normL2["normL2"]
  vector_not_eq_I8P["vector_not_eq_I8P"] --> normL2["normL2"]
  vector_not_eq_R16P["vector_not_eq_R16P"] --> normL2["normL2"]
  vector_not_eq_R4P["vector_not_eq_R4P"] --> normL2["normL2"]
  vector_not_eq_R8P["vector_not_eq_R8P"] --> normL2["normL2"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normL2["normL2"]
  normL2["normL2"] --> sq_norm["sq_norm"]
  style normL2 fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
flowchart TD
  projection_onto_plane["projection_onto_plane"] --> distance_vectorial_to_plane["distance_vectorial_to_plane"]
  style projection_onto_plane fill:#3e63dd,stroke:#99b,stroke-width:2px
```
