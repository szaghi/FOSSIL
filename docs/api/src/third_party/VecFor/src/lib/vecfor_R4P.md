...
**Source**: `src/third_party/VecFor/src/lib/vecfor_R4P.F90`

**Dependencies**

```mermaid
graph LR
  vecfor_R4P["vecfor_R4P"] --> iso_fortran_env["iso_fortran_env"]
  vecfor_R4P["vecfor_R4P"] --> penf["penf"]
```

## Contents

- [vector_R4P](#vector-r4p)
...
- [rotation_matrix_R4P](#rotation-matrix-r4p)
- [mirror_matrix_R4P](#mirror-matrix-r4p)
...
- [parallel](#parallel)
- [angle_R4P](#angle-r4p)
- [distance_to_line_R4P](#distance-to-line-r4p)
- [distance_to_plane_R4P](#distance-to-plane-r4p)
- [distance_vectorial_to_plane_R4P](#distance-vectorial-to-plane-r4p)
- [face_normal3_R4P](#face-normal3-r4p)
- [face_normal4_R4P](#face-normal4-r4p)
- [iolen_R4P](#iolen-r4p)
- [is_collinear_R4P](#is-collinear-r4p)
- [is_concyclic_R4P](#is-concyclic-r4p)
- [normalized_R4P](#normalized-r4p)
- [normL2_R4P](#norml2-r4p)
- [projection_onto_plane_R4P](#projection-onto-plane-r4p)
- [sq_norm_R4P](#sq-norm-r4p)
...
|------|------|------------|-------------|
| `ex_R4P` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | parameter | X direction versor. |
| `ey_R4P` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | parameter | Y direction versor. |
| `ez_R4P` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | parameter | Z direction versor. |
...
| Name | Type | Attributes | Description |
|------|------|------------|-------------|
| `x` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in x direction. |
| `y` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in y direction. |
| `z` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in z direction. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Vector. |
...
flowchart TD
  ...
  normalize["normalize"] --> normL2_R4P["normL2_R4P"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Vector. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Vector data. |
| `unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Logic unit. |
| `fmt` | character(len=*) | in | optional | IO format. |
| `pos` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Position specifier. |
| `iostat` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | IO error. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Vector. |
| `normal` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Normal of mirroring plane. |
...
flowchart TD
  ...
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix_R4P["mirror_matrix_R4P"]
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Vector. |
| `matrix` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Mirroring matrix. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Vector. |
| `axis` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Axis of rotation. |
| `angle` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Angle of rotation. |
...
flowchart TD
  ...
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix_R4P["rotation_matrix_R4P"]
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Vector. |
| `matrix` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Rotation matrix. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | inout |  | Left hand side. |
| `rhs` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Right hand side. |
...
```fortran
function rotation_matrix_R4P(axis, angle) result(matrix)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `axis` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Axis of ratation. |
| `angle` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Angle of ratation. |
...
flowchart TD
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix_R4P["rotation_matrix_R4P"]
  rotation_matrix_R4P["rotation_matrix_R4P"] --> normalized_R4P["normalized_R4P"]
  style rotation_matrix_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function mirror_matrix_R4P(normal) result(matrix)
```
...
flowchart TD
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix_R4P["mirror_matrix_R4P"]
  mirror_matrix_R4P["mirror_matrix_R4P"] --> normalized_R4P["normalized_R4P"]
  style mirror_matrix_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
**Returns**: type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p))
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Left hand side. |
| `rhs` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Right hand side. |
...
| `rhs` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Compute the component of `lhs` parallel to `rhs`. |
| `rhs` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Right hand side. |
...
```mermaid
flowchart TD
  parallel["parallel"] --> normL2_R4P["normL2_R4P"]
  parallel["parallel"] --> normalized_R4P["normalized_R4P"]
...
```fortran
function angle_R4P(self, other) result(angle_)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | The first vector. |
| `other` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Other vector. |

**Call graph**

```mermaid
flowchart TD
  angle_R4P["angle_R4P"] --> normL2_R4P["normL2_R4P"]
  angle_R4P["angle_R4P"] --> normalized["normalized"]
  style angle_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function distance_to_line_R4P(self, pt1, pt2) result(distance)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | First line point. |
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second line point. |

**Call graph**

```mermaid
flowchart TD
  distance_to_line_R4P["distance_to_line_R4P"] --> normL2_R4P["normL2_R4P"]
  style distance_to_line_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function distance_to_plane_R4P(self, pt1, pt2, pt3) result(distance)
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | First plane point. |
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second plane point. |
| `pt3` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Third plane point. |

**Call graph**

```mermaid
flowchart TD
  distance_to_plane_R4P["distance_to_plane_R4P"] --> face_normal3_R4P["face_normal3_R4P"]
  style distance_to_plane_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
 ...
 pt(2) = ey_R4P
 pt(3) = ex_R4P - ey_R4P
 pt(0) = distance_vectorial_to_plane_R4P(pt(0), pt1=pt(1), pt2=pt(2), pt3=pt(3))
 print "(3(F3.1,1X))", pt(0)%x, pt(0)%y, pt(0)%z
```
...
```fortran
function distance_vectorial_to_plane_R4P(self, pt1, pt2, pt3) result(distance)
```
...
```mermaid
flowchart TD
  distance_vectorial_to_plane_R4P["distance_vectorial_to_plane_R4P"] --> face_normal3_R4P["face_normal3_R4P"]
  style distance_vectorial_to_plane_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function face_normal3_R4P(pt1, pt2, pt3, norm) result(normal)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `pt1` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | First face point. |
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second face point. |
| `pt3` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Third face point. |
...
flowchart TD
  distance_to_plane_R4P["distance_to_plane_R4P"] --> face_normal3_R4P["face_normal3_R4P"]
  distance_vectorial_to_plane_R4P["distance_vectorial_to_plane_R4P"] --> face_normal3_R4P["face_normal3_R4P"]
  face_normal3_R4P["face_normal3_R4P"] --> normalized_R4P["normalized_R4P"]
  style face_normal3_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function face_normal4_R4P(pt1, pt2, pt3, pt4, norm) result(normal)
```
...
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second face point. |
| `pt3` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Third face point. |
| `pt4` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Fourth face point. |
| `norm` | character(len=1) | in | optional | If 'norm' is passed as argument the normal is normalized. |
...
```mermaid
flowchart TD
  face_normal4_R4P["face_normal4_R4P"] --> normalized_R4P["normalized_R4P"]
  style face_normal4_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function iolen_R4P(self) result(iolen_)
```
...
```fortran
function is_collinear_R4P(self, pt1, pt2, tolerance) result(is_collinear_)
```
...
| `pt1` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | First line point. |
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second line point. |
| `tolerance` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Tolerance for collinearity check. |

**Call graph**

```mermaid
flowchart TD
  is_collinear_R4P["is_collinear_R4P"] --> distance_to_line["distance_to_line"]
  style is_collinear_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function is_concyclic_R4P(self, pt1, pt2, pt3, tolerance) result(is_concyclic_)
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Vector. |
| `pt1` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | First arc point. |
| `pt2` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Second arc point. |
| `pt3` | type([vector_R4P](/api/src/third_party/VecFor/src/lib/vecfor_R4P#vector-r4p)) | in |  | Third arc point. |
| `tolerance` | real(kind=[R4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Tolerance for concyclicity check. |

**Call graph**

```mermaid
flowchart TD
  is_concyclic_R4P["is_concyclic_R4P"] --> sq_norm_R4P["sq_norm_R4P"]
  style is_concyclic_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function normalized_R4P(self) result(norm)
```
...
flowchart TD
  ...
  parallel["parallel"] --> normalized_R4P["normalized_R4P"]
  rotation_matrix_R4P["rotation_matrix_R4P"] --> normalized_R4P["normalized_R4P"]
  vector_eq_vector["vector_eq_vector"] --> normalized_R4P["normalized_R4P"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normalized_R4P["normalized_R4P"]
  normalized_R4P["normalized_R4P"] --> normalize["normalize"]
  style normalized_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function normL2_R4P(self) result(norm)
```
...
```mermaid
flowchart TD
  I1P_eq_vector["I1P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I1P_great_eq_vector["I1P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I1P_great_vector["I1P_great_vector"] --> normL2_R4P["normL2_R4P"]
  I1P_low_eq_vector["I1P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I1P_low_vector["I1P_low_vector"] --> normL2_R4P["normL2_R4P"]
  I1P_not_eq_vector["I1P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_eq_vector["I2P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_great_eq_vector["I2P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_great_vector["I2P_great_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_low_eq_vector["I2P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_low_vector["I2P_low_vector"] --> normL2_R4P["normL2_R4P"]
  I2P_not_eq_vector["I2P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_eq_vector["I4P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_great_eq_vector["I4P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_great_vector["I4P_great_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_low_eq_vector["I4P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_low_vector["I4P_low_vector"] --> normL2_R4P["normL2_R4P"]
  I4P_not_eq_vector["I4P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_eq_vector["I8P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_great_eq_vector["I8P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_great_vector["I8P_great_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_low_eq_vector["I8P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_low_vector["I8P_low_vector"] --> normL2_R4P["normL2_R4P"]
  I8P_not_eq_vector["I8P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_eq_vector["R16P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_great_eq_vector["R16P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_great_vector["R16P_great_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_low_eq_vector["R16P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_low_vector["R16P_low_vector"] --> normL2_R4P["normL2_R4P"]
  R16P_not_eq_vector["R16P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_eq_vector["R4P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_great_eq_vector["R4P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_great_vector["R4P_great_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_low_eq_vector["R4P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_low_vector["R4P_low_vector"] --> normL2_R4P["normL2_R4P"]
  R4P_not_eq_vector["R4P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_eq_vector["R8P_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_great_eq_vector["R8P_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_great_vector["R8P_great_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_low_eq_vector["R8P_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_low_vector["R8P_low_vector"] --> normL2_R4P["normL2_R4P"]
  R8P_not_eq_vector["R8P_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  angle_R4P["angle_R4P"] --> normL2_R4P["normL2_R4P"]
  distance_to_line_R4P["distance_to_line_R4P"] --> normL2_R4P["normL2_R4P"]
  normalize["normalize"] --> normL2_R4P["normL2_R4P"]
  parallel["parallel"] --> normL2_R4P["normL2_R4P"]
  vector_eq_I1P["vector_eq_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_I2P["vector_eq_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_I4P["vector_eq_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_I8P["vector_eq_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_R16P["vector_eq_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_R4P["vector_eq_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_R8P["vector_eq_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_eq_vector["vector_eq_vector"] --> normL2_R4P["normL2_R4P"]
  vector_great_I1P["vector_great_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_great_I2P["vector_great_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_great_I4P["vector_great_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_great_I8P["vector_great_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_great_R16P["vector_great_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_great_R4P["vector_great_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_great_R8P["vector_great_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_I1P["vector_great_eq_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_I2P["vector_great_eq_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_I4P["vector_great_eq_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_I8P["vector_great_eq_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_R16P["vector_great_eq_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_R4P["vector_great_eq_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_R8P["vector_great_eq_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_great_eq_vector["vector_great_eq_vector"] --> normL2_R4P["normL2_R4P"]
  vector_great_vector["vector_great_vector"] --> normL2_R4P["normL2_R4P"]
  vector_low_I1P["vector_low_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_low_I2P["vector_low_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_low_I4P["vector_low_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_low_I8P["vector_low_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_low_R16P["vector_low_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_low_R4P["vector_low_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_low_R8P["vector_low_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_I1P["vector_low_eq_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_I2P["vector_low_eq_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_I4P["vector_low_eq_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_I8P["vector_low_eq_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_R16P["vector_low_eq_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_R4P["vector_low_eq_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_R8P["vector_low_eq_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_low_eq_vector["vector_low_eq_vector"] --> normL2_R4P["normL2_R4P"]
  vector_low_vector["vector_low_vector"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_I1P["vector_not_eq_I1P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_I2P["vector_not_eq_I2P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_I4P["vector_not_eq_I4P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_I8P["vector_not_eq_I8P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_R16P["vector_not_eq_R16P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_R4P["vector_not_eq_R4P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_R8P["vector_not_eq_R8P"] --> normL2_R4P["normL2_R4P"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normL2_R4P["normL2_R4P"]
  normL2_R4P["normL2_R4P"] --> sq_norm["sq_norm"]
  style normL2_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function projection_onto_plane_R4P(self, pt1, pt2, pt3) result(projection)
```
...
```mermaid
flowchart TD
  projection_onto_plane_R4P["projection_onto_plane_R4P"] --> distance_vectorial_to_plane["distance_vectorial_to_plane"]
  style projection_onto_plane_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function sq_norm_R4P(self) result(sq)
```
...
flowchart TD
  is_concyclic_R4P["is_concyclic_R4P"] --> sq_norm_R4P["sq_norm_R4P"]
  style sq_norm_R4P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
