...
**Source**: `src/third_party/VecFor/src/lib/vecfor_R16P.F90`

**Dependencies**

```mermaid
graph LR
  vecfor_R16P["vecfor_R16P"] --> iso_fortran_env["iso_fortran_env"]
  vecfor_R16P["vecfor_R16P"] --> penf["penf"]
```

## Contents

- [vector_R16P](#vector-r16p)
...
- [rotation_matrix_R16P](#rotation-matrix-r16p)
- [mirror_matrix_R16P](#mirror-matrix-r16p)
- [crossproduct_RPP](#crossproduct-rpp)
- [dotproduct](#dotproduct)
- [matrixproduct](#matrixproduct)
- [orthogonal](#orthogonal)
- [parallel](#parallel)
- [angle_R16P](#angle-r16p)
- [distance_to_line_R16P](#distance-to-line-r16p)
- [distance_to_plane_R16P](#distance-to-plane-r16p)
- [distance_vectorial_to_plane_R16P](#distance-vectorial-to-plane-r16p)
- [face_normal3_R16P](#face-normal3-r16p)
- [face_normal4_R16P](#face-normal4-r16p)
- [iolen_R16P](#iolen-r16p)
- [is_collinear_R16P](#is-collinear-r16p)
- [is_concyclic_R16P](#is-concyclic-r16p)
- [normalized_R16P](#normalized-r16p)
- [normL2_R16P](#norml2-r16p)
- [projection_onto_plane_R16P](#projection-onto-plane-r16p)
- [sq_norm_R16P](#sq-norm-r16p)
...
|------|------|------------|-------------|
| `ex_R16P` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | parameter | X direction versor. |
| `ey_R16P` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | parameter | Y direction versor. |
| `ez_R16P` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | parameter | Z direction versor. |
...
| Name | Type | Attributes | Description |
|------|------|------------|-------------|
| `x` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in x direction. |
| `y` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in y direction. |
| `z` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) |  | Cartesian component in z direction. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
...
flowchart TD
  ...
  normalize["normalize"] --> normL2_R16P["normL2_R16P"]
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector data. |
| `unit` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Logic unit. |
| `fmt` | character(len=*) | in | optional | IO format. |
| `pos` | integer(kind=[I8P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Position specifier. |
| `iostat` | integer(kind=[I4P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | out | optional | IO error. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `normal` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Normal of mirroring plane. |
...
flowchart TD
  ...
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix_R16P["mirror_matrix_R16P"]
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `matrix` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Mirroring matrix. |
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `axis` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Axis of rotation. |
| `angle` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Angle of rotation. |
...
flowchart TD
  ...
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix_R16P["rotation_matrix_R16P"]
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Vector. |
| `matrix` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Rotation matrix. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | inout |  | Left hand side. |
| `rhs` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
```fortran
function rotation_matrix_R16P(axis, angle) result(matrix)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `axis` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Axis of ratation. |
| `angle` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in |  | Angle of ratation. |
...
flowchart TD
  rotate_by_axis_angle["rotate_by_axis_angle"] --> rotation_matrix_R16P["rotation_matrix_R16P"]
  rotation_matrix_R16P["rotation_matrix_R16P"] --> normalized_R16P["normalized_R16P"]
  style rotation_matrix_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function mirror_matrix_R16P(normal) result(matrix)
```
...
flowchart TD
  mirror_by_normal["mirror_by_normal"] --> mirror_matrix_R16P["mirror_matrix_R16P"]
  mirror_matrix_R16P["mirror_matrix_R16P"] --> normalized_R16P["normalized_R16P"]
  style mirror_matrix_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
**Returns**: type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p))
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Left hand side. |
| `rhs` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
| `rhs` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `lhs` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Compute the component of `lhs` parallel to `rhs`. |
| `rhs` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Right hand side. |
...
```mermaid
flowchart TD
  parallel["parallel"] --> normL2_R16P["normL2_R16P"]
  parallel["parallel"] --> normalized_R16P["normalized_R16P"]
...
```fortran
function angle_R16P(self, other) result(angle_)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | The first vector. |
| `other` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Other vector. |

**Call graph**

```mermaid
flowchart TD
  angle_R16P["angle_R16P"] --> normL2_R16P["normL2_R16P"]
  angle_R16P["angle_R16P"] --> normalized["normalized"]
  style angle_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function distance_to_line_R16P(self, pt1, pt2) result(distance)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | First line point. |
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second line point. |

**Call graph**

```mermaid
flowchart TD
  distance_to_line_R16P["distance_to_line_R16P"] --> normL2_R16P["normL2_R16P"]
  style distance_to_line_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function distance_to_plane_R16P(self, pt1, pt2, pt3) result(distance)
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | The point from which computing the distance. |
| `pt1` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | First plane point. |
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second plane point. |
| `pt3` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third plane point. |

**Call graph**

```mermaid
flowchart TD
  distance_to_plane_R16P["distance_to_plane_R16P"] --> face_normal3_R16P["face_normal3_R16P"]
  style distance_to_plane_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function distance_vectorial_to_plane_R16P(self, pt1, pt2, pt3) result(distance)
```
...
```mermaid
flowchart TD
  distance_vectorial_to_plane_R16P["distance_vectorial_to_plane_R16P"] --> face_normal3_R16P["face_normal3_R16P"]
  style distance_vectorial_to_plane_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function face_normal3_R16P(pt1, pt2, pt3, norm) result(normal)
```
...
| Name | Type | Intent | Attributes | Description |
|------|------|--------|------------|-------------|
| `pt1` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | First face point. |
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second face point. |
| `pt3` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third face point. |
...
flowchart TD
  distance_to_plane_R16P["distance_to_plane_R16P"] --> face_normal3_R16P["face_normal3_R16P"]
  distance_vectorial_to_plane_R16P["distance_vectorial_to_plane_R16P"] --> face_normal3_R16P["face_normal3_R16P"]
  face_normal3_R16P["face_normal3_R16P"] --> normalized_R16P["normalized_R16P"]
  style face_normal3_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function face_normal4_R16P(pt1, pt2, pt3, pt4, norm) result(normal)
```
...
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second face point. |
| `pt3` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third face point. |
| `pt4` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Fourth face point. |
| `norm` | character(len=1) | in | optional | If 'norm' is passed as argument the normal is normalized. |
...
```mermaid
flowchart TD
  face_normal4_R16P["face_normal4_R16P"] --> normalized_R16P["normalized_R16P"]
  style face_normal4_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function iolen_R16P(self) result(iolen_)
```
...
```fortran
function is_collinear_R16P(self, pt1, pt2, tolerance) result(is_collinear_)
```
...
| `pt1` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | First line point. |
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second line point. |
| `tolerance` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Tolerance for collinearity check. |

**Call graph**

```mermaid
flowchart TD
  is_collinear_R16P["is_collinear_R16P"] --> distance_to_line["distance_to_line"]
  style is_collinear_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function is_concyclic_R16P(self, pt1, pt2, pt3, tolerance) result(is_concyclic_)
```
...
|------|------|--------|------------|-------------|
| `self` | class([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Vector. |
| `pt1` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | First arc point. |
| `pt2` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Second arc point. |
| `pt3` | type([vector_R16P](/api/src/third_party/VecFor/src/lib/vecfor_R16P#vector-r16p)) | in |  | Third arc point. |
| `tolerance` | real(kind=[R16P](/api/src/third_party/PENF/src/lib/penf_global_parameters_variables)) | in | optional | Tolerance for concyclicity check. |

**Call graph**

```mermaid
flowchart TD
  is_concyclic_R16P["is_concyclic_R16P"] --> sq_norm_R16P["sq_norm_R16P"]
  style is_concyclic_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function normalized_R16P(self) result(norm)
```
...
flowchart TD
  ...
  parallel["parallel"] --> normalized_R16P["normalized_R16P"]
  rotation_matrix_R16P["rotation_matrix_R16P"] --> normalized_R16P["normalized_R16P"]
  vector_eq_vector["vector_eq_vector"] --> normalized_R16P["normalized_R16P"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normalized_R16P["normalized_R16P"]
  normalized_R16P["normalized_R16P"] --> normalize["normalize"]
  style normalized_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function normL2_R16P(self) result(norm)
```
...
```mermaid
flowchart TD
  I1P_eq_vector["I1P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I1P_great_eq_vector["I1P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I1P_great_vector["I1P_great_vector"] --> normL2_R16P["normL2_R16P"]
  I1P_low_eq_vector["I1P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I1P_low_vector["I1P_low_vector"] --> normL2_R16P["normL2_R16P"]
  I1P_not_eq_vector["I1P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_eq_vector["I2P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_great_eq_vector["I2P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_great_vector["I2P_great_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_low_eq_vector["I2P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_low_vector["I2P_low_vector"] --> normL2_R16P["normL2_R16P"]
  I2P_not_eq_vector["I2P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_eq_vector["I4P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_great_eq_vector["I4P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_great_vector["I4P_great_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_low_eq_vector["I4P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_low_vector["I4P_low_vector"] --> normL2_R16P["normL2_R16P"]
  I4P_not_eq_vector["I4P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_eq_vector["I8P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_great_eq_vector["I8P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_great_vector["I8P_great_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_low_eq_vector["I8P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_low_vector["I8P_low_vector"] --> normL2_R16P["normL2_R16P"]
  I8P_not_eq_vector["I8P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_eq_vector["R16P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_great_eq_vector["R16P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_great_vector["R16P_great_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_low_eq_vector["R16P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_low_vector["R16P_low_vector"] --> normL2_R16P["normL2_R16P"]
  R16P_not_eq_vector["R16P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_eq_vector["R4P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_great_eq_vector["R4P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_great_vector["R4P_great_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_low_eq_vector["R4P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_low_vector["R4P_low_vector"] --> normL2_R16P["normL2_R16P"]
  R4P_not_eq_vector["R4P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_eq_vector["R8P_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_great_eq_vector["R8P_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_great_vector["R8P_great_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_low_eq_vector["R8P_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_low_vector["R8P_low_vector"] --> normL2_R16P["normL2_R16P"]
  R8P_not_eq_vector["R8P_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  angle_R16P["angle_R16P"] --> normL2_R16P["normL2_R16P"]
  distance_to_line_R16P["distance_to_line_R16P"] --> normL2_R16P["normL2_R16P"]
  normalize["normalize"] --> normL2_R16P["normL2_R16P"]
  parallel["parallel"] --> normL2_R16P["normL2_R16P"]
  vector_eq_I1P["vector_eq_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_I2P["vector_eq_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_I4P["vector_eq_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_I8P["vector_eq_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_R16P["vector_eq_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_R4P["vector_eq_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_R8P["vector_eq_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_eq_vector["vector_eq_vector"] --> normL2_R16P["normL2_R16P"]
  vector_great_I1P["vector_great_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_great_I2P["vector_great_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_great_I4P["vector_great_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_great_I8P["vector_great_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_great_R16P["vector_great_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_great_R4P["vector_great_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_great_R8P["vector_great_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_I1P["vector_great_eq_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_I2P["vector_great_eq_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_I4P["vector_great_eq_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_I8P["vector_great_eq_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_R16P["vector_great_eq_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_R4P["vector_great_eq_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_R8P["vector_great_eq_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_great_eq_vector["vector_great_eq_vector"] --> normL2_R16P["normL2_R16P"]
  vector_great_vector["vector_great_vector"] --> normL2_R16P["normL2_R16P"]
  vector_low_I1P["vector_low_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_low_I2P["vector_low_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_low_I4P["vector_low_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_low_I8P["vector_low_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_low_R16P["vector_low_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_low_R4P["vector_low_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_low_R8P["vector_low_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_I1P["vector_low_eq_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_I2P["vector_low_eq_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_I4P["vector_low_eq_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_I8P["vector_low_eq_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_R16P["vector_low_eq_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_R4P["vector_low_eq_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_R8P["vector_low_eq_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_low_eq_vector["vector_low_eq_vector"] --> normL2_R16P["normL2_R16P"]
  vector_low_vector["vector_low_vector"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_I1P["vector_not_eq_I1P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_I2P["vector_not_eq_I2P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_I4P["vector_not_eq_I4P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_I8P["vector_not_eq_I8P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_R16P["vector_not_eq_R16P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_R4P["vector_not_eq_R4P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_R8P["vector_not_eq_R8P"] --> normL2_R16P["normL2_R16P"]
  vector_not_eq_vector["vector_not_eq_vector"] --> normL2_R16P["normL2_R16P"]
  normL2_R16P["normL2_R16P"] --> sq_norm["sq_norm"]
  style normL2_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function projection_onto_plane_R16P(self, pt1, pt2, pt3) result(projection)
```
...
```mermaid
flowchart TD
  projection_onto_plane_R16P["projection_onto_plane_R16P"] --> distance_vectorial_to_plane["distance_vectorial_to_plane"]
  style projection_onto_plane_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
...
```fortran
function sq_norm_R16P(self) result(sq)
```
...
flowchart TD
  is_concyclic_R16P["is_concyclic_R16P"] --> sq_norm_R16P["sq_norm_R16P"]
  style sq_norm_R16P fill:#3e63dd,stroke:#99b,stroke-width:2px
```
