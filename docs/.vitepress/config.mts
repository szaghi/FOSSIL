      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Cotangent Laplacian',        link: '/guide/advanced/cotangent-laplacian' },
            { text: 'Per-vertex curvature',       link: '/guide/advanced/curvature' },
            { text: 'Mesh smoothing',             link: '/guide/advanced/smoothing' },
          ],
        },
        {
          text: 'Project',
